...
<body>
	...
	<div class="main-content">
		...
		<!-- start btn to see all the products of this range -->

		<section>
			<div class="container">
				<div class="product_list range_all">
					<div class="row">

						<div class="col-md-12 col-md-offset-0 col-xs-10 col-xs-offset-1">
							<div class="btn--filter range--btn fright">
								<a href="product_listing.php" alt="Filtrar" class="btn btn--gray">
					...
					<div class="col-md-3 col-md-offset-1 col-sm-8 col-sm-offset-2 col-xs-11 col-xs-offset-0 fleft content-float-down">
						<ul>
							<li class="detail_range--each">
								...
								<div class="detail_range__text">
									<h4>Durable wear Layer</h4>
									<p>Superfície Supertop</p>
								</div>
							...
							<li class="detail_range--each">
								...
								<div class="detail_range__text">
									<h4>High - Resolution Printed Film</h4>
									<p>Realistic and attractive Wood and Stone look</p>
								</div>
							</li>
							<li class="detail_range--each">
								<div class="detail_range__num">
								...
								<div class="detail_range__text">
									<h4>Agglomerated Cork</h4>
									<p>Reduces step sound and increases thermal efficiency and overall overall comfort</p>
								</div>
							</li>
							<li class="detail_range--each">
								<div class="detail_range__num">
								...
								<div class="detail_range__text">
									<h4>HDF - High Density Fiberboard</h4>
									<p>&nbsp;</p>
								</div>
							</li>
							<li class="detail_range--each">
								...
								<div class="detail_range__text">
									<h4>Integrated cork underlay</h4>
									<p>Provides noise reduction and termal reinforcement</p>
								</div>
							</li>
						</ul>
					</div>
						...
						<div class="product_finder--container --info-range">
							...
							<div class="row">
								<div class="col-lg-4 col-lg-offset-2 col-xs-10 col-xs-offset-1">
									<p>Pequena descrição desta gama de produtos Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eos ratione minus
										vero repellat quos modi at placeat iste. Odit ab ipsum, provident facilis exercitationem autem? Porro perferendis
										pariatur ex totam!</p>
			...
			<div class="row">
				<div class="dealer">
					<div class="col-md-4 col-xs-10">
						<div class="slide_image_container--left">
							<div class="gray_bg--left"></div>
							<img src="assets/img/img_dealer.jpg" alt="Onde Comprar" class="image img-responsive">
						</div>
