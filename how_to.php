	...
	<div class="main-content">
		...
		<section>
			...
			<div class="container">
				...
				<div class="row how_to_container">
					<div class="col-xs-12">
						<div class="row">
							<div class="col-md-offset-2 col-md-8 col-xs-offset-1 col-xs-10">
								<a href="how_to_detail.php" alt="#">
									<div class="how_to_container__items to--left">
										<div class="how_to_container--text">
											<h2>Flutuantes</h2>
											<h3>PressFit</h3>
										</div>
									</div>
					...
					<div class="col-xs-12">
						<div class="row">
							<div class="col-md-8 col-md-offset-2 col-xs-10 col-xs-offset-1">
								<a href="how_to_detail.php" alt="#">
									<img src="https://dummyimage.com/704x245/ccc/fff" alt="https://dummyimage.com/704x245/ccc/fff" class="img-responsive img--right">
									<div class="how_to_container__items to--right">
										<div class="how_to_container--text">
											<h2>Flutuantes</h2>
											<h3>2D</h3>
										</div>
