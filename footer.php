	...
	<footer>
		<div class="container">
			<div class="col-md-3 col-xs-12">
				<a href="#" alt="Corklife">
					<img src="assets/img/logo_vazado.png" title="Corklife" class="img-responsive">
				</a>
				<!-- <a href="#" alt="Corktech" class="hidden-xs">
					<img src="assets/img/selo_corktech.png" title="Corktech" class="img-responsive corktech">
				</a> -->
			</div>
			...
			<div class="col-md-3 col-xs-12">
				...
				<form action="#" class="newsletter">
					<span class="title">Subscreva a nossa newsletter</span>
					<input type="text" placeholder="Email">
					<button type="button" class="btn--subscrever">
						<i class="fa fa-arrow-right" aria-hidden="true"></i>
					</button>
				</form> -->
				<div class="why_corktech">
					<a href="#" alt="Corktech" class="fleft hidden-xs">
						<img src="assets/img/selo_corktech.png" title="Corktech" class="img-responsive">
					</a>

					<div class="text">

						<h5>Porquê Corktech?</h5>
						<p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eius veniam.</p>
						<a href="#" alt="" class="btn btn--footer">Saiba Mais</a>
					</div>
	...
	<div class="container">
		...
		<div class="col-md-1 col-md-offset-2 footer-space">
			<a href="#" title="Desenvolvido por Loba">
				<img src="assets/img/loba.png" alt="Loba">
			</a>
		</div>
	</div>
</div>