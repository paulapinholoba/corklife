			...
			<div class="row">
				<div class="image-spaces">
					...
					<div class="col-md-3 col-md-offset-1 col-xs-10 col-xs-offset-1">
						<div class="highlight_txt--big">Amorim Revestimentos</div>
					</div>
			...
			<div class="col-md-4 col-md-offset-1 col-xs-11 col-xs-offset-1">
				<div class="darker-container--right">
					<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum illum necessitatibus iure omnis velit architecto minus
						consectetur, porro et! Mollitia harum assumenda aspernatur excepturi, cum commodi quam sequi laborum! Praesentium.</p>
				</div>
				<div class="darker-container--right--under"></div>
			</div>
				...
				<div class="row">
					...
					<div class="col-xs-12">
						<div class="row">
							...
							<div class="col-xs-12 col-md-6 graphs_block--content tab-pane active" id="silencio">
								<p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Tempora, doloremque! Non optio, rem voluptatibus hic fugiat
									quasi totam est dolor, magnam modi, aut eum temporibus ipsa asperiores nihil! Tempora, commodi?</p>
								<img src="https://dummyimage.com/600x400/cccccc/fff" alt="https://dummyimage.com/600x400/cccccc/fff" class="img-responsive">
							</div>
							<div class="col-xs-12 col-md-6  graphs_block--content tab-pane" id="isolante">
								<p>Isto é o texto sobre o isolante térmico. Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora, doloremque!
									Non optio, rem voluptatibus hic fugiat quasi totam est dolor, magnam modi, aut eum temporibus ipsa asperiores nihil!
									Tempora, commodi?</p>
								<img src="https://dummyimage.com/600x400/49b8eb/fff" alt="https://dummyimage.com/600x400/49b8eb/fff" class="img-responsive">
							</div>
							<div class="col-xs-12 col-md-6  graphs_block--content tab-pane" id="conforto">
								<p>Isto é o texto do conforto. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Tempora, doloremque! Non optio,
									rem voluptatibus hic fugiat quasi totam est dolor, magnam modi, aut eum temporibus ipsa asperiores nihil! Tempora,
									commodi?
								</p>
								<img src="https://dummyimage.com/600x400/cccccc/fff" alt="https://dummyimage.com/600x400/cccccc/fff" class="img-responsive">
							</div>
							<div class="col-xs-12 col-md-6  graphs_block--content tab-pane" id="resistencia">
								<p>Isto é o texto da resistência. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Tempora, doloremque! Non
